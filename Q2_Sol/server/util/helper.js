...
let allTitles = jsonData.titles; //store all titles
let allAuthors = jsonData.authors; //store all authors
...
//calculate substring instances in summaries and sort them
