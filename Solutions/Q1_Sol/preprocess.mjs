...
export const sortPreProcessedDataInstances = unsorted_data => {
...
export const storePreProcessedDataInJSONToFile = sorted_data => {
  writeFile('cache.json', JSON.stringify(sorted_data), err => {
    // In case of a error throw err.
    if (err) throw err;
  });
};

export const processData = (inputStr, bulkProcessing) => {
...
export const preprocess = (inputStr, bulkProcessing = true) => {
